...
/* harmony import */ var _root_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./root.service */ "./src/app/root.service.ts");
...
let AppComponent = class AppComponent {
    constructor(iconRegistry, sanitizer, router, rootService) {
...
/* harmony import */ var _root_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./root.service */ "./src/app/root.service.ts");
...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | pizza-pizza-module */ "pizza-pizza-module").then(__webpack_require__.bind(null, /*! ./pizza/pizza.module */ "./src/app/pizza/pizza.module.ts")).then(m => m.PizzaModule)
    }
];
...
module.exports = __webpack_require__(/*! D:\realtime-pizza-ui\src\main.ts */"./src/main.ts");
